    ...
    this.links = [
        {
            ...
            title: 'Somaj',
            path: 'somaj',
            src: this.getSafeUrl('https://covid19.geo-spatial.org/external/charts_vasile/impact/impact_populatie_forta_munca_somaj.html'),
            src_mobile: this.getSafeUrl('https://covid19.geo-spatial.org/external/charts_vasile/impact/impact_populatie_forta_munca_somaj_mobile.html')
        }
    ];
