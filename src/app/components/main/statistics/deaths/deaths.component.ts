...
export class DeathsComponent implements OnInit {
  ...
  translateValues(){
    this.list = [
      {
        id: 1,
        title: this.translate.instant('statistics.Evoluție decese noi pe zile'),
      ...
      {
        id: 2,
        title: this.translate.instant('statistics.Evoluție decese pe zile'),
      ...
      {
        id: 3,
        title: this.translate.instant('statistics.Decese înregistrate pe județ'),
      ...
      {
        id: 4,
        title: this.translate.instant('statistics.Decese înregistrate pe intervale de vârstă'),
      ...
      {
        id: 5,
        title: this.translate.instant('statistics.Interval timp (zile) de la deces la comunicatul Ministerului Sănătății'),
      ...
      {
        id: 6,
        title: this.translate.instant('statistics.Decese înregistrate pe gen'),
      ...
      {
        id: 7,
        title: this.translate.instant('statistics.Decese confirmate post-mortem'),
      ...
      {
        id: 8,
        title: this.translate.instant('statistics.Frecvență decese după generație'),
      ...
      {
        id: 9,
        title: this.translate.instant('statistics.Cazuri și decese dupa vârstă'),
      ...
      {
        id: 10,
        title: this.translate.instant('statistics.Decese/Vârstă și gen'),
      ...
      {
        id: 11,
        title: this.translate.instant('statistics.Decese înregistrate la persoane internate în spital'),
      ...
      {
        id: 12,
        title: this.translate.instant('statistics.Perioada Test - Confirmare Covid 19 (zile)'),
      ...
      {
        id: 13,
        title: this.translate.instant('statistics.Perioada Confirmare Covid 19 - Deces (zile)'),
